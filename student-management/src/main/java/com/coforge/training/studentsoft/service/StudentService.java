...
public class StudentService {
	...
	public int save(Student student) {
		return studentDAO.save(student);   //Call Save Method of DAO class
	}
	
	public List<Student> getAllStudents() {
		return studentDAO.listAll();        //call Delete method of DAO class
	}
	...
	public Student getSingleStudent(int rollNo) {	
		return studentDAO.get(rollNo); //call delete method of DAO class
	}
